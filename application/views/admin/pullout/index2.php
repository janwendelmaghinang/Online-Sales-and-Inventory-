...
<ul class="nav nav-tabs my-3">
  ...
  <li class="nav-item">
    <a id="link2" class="mx-2 text-dark btn btn-outline-dark notification" href="<?php echo base_url('Admin_Pullout/completed') ?>">Completed <span class="badge"><?php  ?></a>
  </li>
  <li class="nav-item">
    <a id="link3" class="mx-2 text-light btn btn-outline-dark notification" href="<?php echo base_url('Admin_Pullout/Cancelled') ?>">Cancel <span class="badge"><?php ?></a>
  </li>
</ul>
...
pulloutTable = $('#pulloutTable').DataTable({
  'ajax': '<?php echo base_url('Admin_Pullout/fetchCancelled')?>',
  'order': []
});
