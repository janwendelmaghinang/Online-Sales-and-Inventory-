...
<ul class="nav nav-tabs my-3">
  <li class="nav-item">
    <a id="link1" class="mx-2 text-light btn btn-outline-dark notification" href="<?php echo base_url('Admin_Pullout') ?>">Pending<span class="badge"><?php  ?></span></a>
  </li>
  <li class="nav-item">
...
pulloutTable = $('#pulloutTable').DataTable({
  'ajax': '<?php echo base_url('Admin_Pullout/fetchPullout')?>',
  'order': []
});
