...
<ul class="nav nav-tabs my-3">
  ...
  <li class="nav-item">
    <a id="link3" class="mx-1 nav-link text-light btn notification" href="<?php echo base_url('Admin_Inquiry/completed') ?>">Completed <span class="badge"><?php ?> </span></a>
  </li>
  <li class="nav-item">
...
inquiryTable = $('#inquiryTable').DataTable({
  'ajax': '<?php echo base_url('Admin_Inquiry/fetchAllCompletedInquiryData')?>',
  'order': []
});
});
