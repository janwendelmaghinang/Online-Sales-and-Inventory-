...
<ul class="nav nav-tabs my-3">
  ...
  <li class="nav-item">
    <a id="link4" class="mx-1 nav-link text-light btn notification" href="<?php echo base_url('Admin_Inquiry/cancelled') ?>">Cancelled <span class="badge"><?php ?> </span></a>
  </li>
</ul>
...
inquiryTable = $('#inquiryTable').DataTable({
  'ajax': '<?php echo base_url('Admin_Inquiry/fetchAllCancelledInquiryData')?>',
  'order': []
});
});
