...
<ul class="nav nav-tabs my-3">
  <li class="nav-item">
    <a id="link1" class="mx-1 nav-link text-light btn notification" href="<?php echo base_url('Admin_Order') ?>">Pending <span class="badge"><?php ?> </span></a>
  </li>
  <li class="nav-item">
...
<div class="modal fade" tabindex="-1" role="dialog" id="readyModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('Admin_Order/update') ?>" method="post" id="readyForm">
        <div class="modal-body">
          <!-- <p class="text-capitalize" id="complete_message"></p> -->
          Are you sure that this order is ready?
        </div>
...
<div class="modal fade" tabindex="-1" role="dialog" id="cancelModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('Admin_Order/update') ?>" method="post" id="cancelForm">
        <div class="modal-body">
...
orderTable = $('#orderTable').DataTable({
  'ajax': '<?php echo base_url('Admin_Order/fetchAllPendingOrderData')?>',
  'order': []
});
});
      ...
      $.ajax({
        ...
        success:function(response) {
          ...
          if(response.success === true) 
          {
              ...
              // send email  
              var mess = 'Your order is now ready';
