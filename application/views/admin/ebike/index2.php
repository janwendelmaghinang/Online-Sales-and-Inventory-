...
<ul class="nav my-3">
  ...
  <li class="nav-item">
    <a id="link3" class=" mx-1 text-light btn btn-outline-dark" href="<?php echo base_url('Admin_Ebike/cancelled') ?>">Cancelled</a>
  </li>
</ul>
<div id="messages"></div>
...
ebikeTable = $('#ebikeTable').DataTable({
  'ajax': '<?php echo base_url('Admin_Ebike/fetchAllProductionData2/3')?>',
  'order': []
});
