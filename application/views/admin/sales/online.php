...
<ul class="nav nav-tabs my-3">
  ...
  <li class="nav-item">
    <a id="link2" class="mx-1 btn btn-outline-dark text-light btn " href="<?php echo base_url('Admin_Sales/online') ?>">Online</a>
  </li>
  <li class="nav-item">
    <a id="link3" class="mx-1 btn btn-outline-dark text-dark btn " href="<?php echo base_url('Admin_Sales/loan') ?>">Ebike Loan</a>
  </li>
  <li class="nav-item">
...
salesTable = $('#salesTable').DataTable({
  'ajax': '<?php echo base_url('Admin_Sales/fetchAllSalesOnline')?>',
  'color': []
});
