...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col mt-2">
            ...
            <table id="ebikeSerialTable" class="table table-bordered table-striped ">
              <thead>
                    <tr>
                        <th>Id</th>
                        <th>Motor Number</th>
...
var ebikeSerialTable = $('#ebikeSerialTable').DataTable({
  'ajax': '<?php echo base_url('Admin_Inventory/fetchAllEbikeSerialData')?>',
  'spareparts': [],
});
